...
function peserico()  {
    ...
    console.log(value);
    if (value == true) {
        let peserico_item = data1.filter(function (elem, index) {
...
function dolce() {
    ...
    console.log(value)
    if (value == true) {
        var dolce_item = data1.filter(function (elem, index) {
...
function valentino() {
    ...
    console.log(value);
    if (value == true) {
        var valentino_item = data1.filter(function (elem, index) {
...
function iro() {
    ...
    console.log(value);
    if (value == true) {
        let iro_item = data1.filter(function (elem, index) {
...
function sandro() {
    ...
    console.log(value);
    if (value == true) {
        var sandro_item = data1.filter(function (elem, index) {
...
document.getElementById('sandro').addEventListener('change',sandro);
         ...
         function $50to$100() {
            ...
            if ($ == true) {
                let $50to$100 = data1.filter(function (elem) {
        ...
        function $101to$200() {
            ...
            if (Rs == true) {
                var Rs1199toRs2098 = data1.filter(function (elem) {
        ...
        function $201to$500() {
            ...
            if (Rs == true) {
                var Rs2098toRs3119 = data1.filter(function (elem) {
        ...
        function $501andabove() {
            ...
            if (Rs == true) {
                var Rs3119toRsabove = data1.filter(function (elem) {
                    if (elem.price > 500) {
                        return elem.price;
                    }
                });
        ...
        function above50() {
            ...
            if (above50 == true) {
                var above50 = data1.filter(function (elem) {
                    if (elem.discount >= 50) {
        ...
        function above60() {
            ...
            if (above60 == true) {
                var above60 = data1.filter(function (elem) {
                    if (elem.discount >= 60) {
                        return elem.discount;
                    }
                });
        ...
        function above70() {
            ...
            if (above70 == true) {
                var above70 = data1.filter(function (elem) {
                    if (elem.discount >= 70) {
                        return elem.discount;
                    }
                });
